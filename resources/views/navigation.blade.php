        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav  ml-auto">
                        ...
                        <li>
                          <a href="/shopping_cart" class=""><i class="fas fa-shopping-cart mr-4  pt-3"></i></a>
                        </li>
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}"><p class="small-txt mt-2">Login</p></a>
                            </li>
                            <li class="nav-item">
                                @if (Route::has('register'))
                                    <a class="nav-link" href="{{ route('register') }}" ><p class="small-txt mt-2">Register</p></a>
                                @endif
                            </li>
                        @else
